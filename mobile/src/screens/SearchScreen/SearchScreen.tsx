...
import { Button, Input, Card, Label, Switch } from '@/components/ui'
...
export default function SearchScreen() {
  ...
  const handleSearch = async (page = 1) => {
    try {
      ...
      if (petsAllowed) query.pets_allowed = true
      if (smokingAllowed) query.smoking_allowed = true
      if (musicAllowed) query.music_allowed = true
        ...
        <View style={styles.searchForm}>
          ...
          {showFilters && (
            <View style={styles.advancedFilters}>
              ...
              {/* Preference Filters */}
              <View style={styles.filterItem}>
                <Label>Preferencias del conductor</Label>
                <Switch
