...
class LocationService {
  ...
  async getDirections(
    ...
    try {
      ...
      // Usar los polylines individuales de cada paso (más detalle que overview_polyline)
      const routeCoordinates = leg.steps.flatMap((step: any) =>
  ...
  async getCurrentLocation(): Promise<Coordinates> {
    try {
      // Intentar posición conocida reciente (instantáneo)
      ...
      // Fallback: nueva lectura con precisión balanceada (más rápido que High)
